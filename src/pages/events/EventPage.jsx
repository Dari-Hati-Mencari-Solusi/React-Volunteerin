      ...
      <section className="mx-auto w-full px-4 sm:px-6 lg:px-8 max-w-screen-xl py-12">
        <div className="flex flex-col lg:flex-row gap-4 py-6 lg:py-10">
          ...
          <div className="w-full lg:w-8/12 space-y-4">
            <div className="mb-6 lg:mb-0">
              ...
              />
              <div className="bg-[#F7F7F7] border-[1.5px] border-[#ECECEC] p-4 sm:p-6 rounded-b-xl">
            ...
            <div className="bg-[#F7F7F7] border-[1.5px] border-[#ECECEC] rounded-lg shadow-sm p-6">
              <div className="flex items-center gap-2 mb-4">
                <Icon
                  icon="gg:notes"
                  width="28"
          ...
          <div className="w-full lg:w-4/12">
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="bg-[#F7F7F7] border-[1.5px] border-[#ECECEC] rounded-b-lg shadow-sm p-6">
                  <div className="space-y-4">
                    {activities.map((activity) => (
                      <div key={activity.id} className="flex gap-4">
                        <span className="text-[#0A3E54] font-medium">
        ...
        <div className="py-5">
          <div className="flex gap-4 flex-col md:flex-row">
            <div className="bg-[#F7F7F7] border-[1.5px] space-y-2 border-[#ECECEC] rounded-[12px] p-6 w-full md:w-1/2 text-[#0A3E54]">
              <div className="flex items-center gap-4 ">
                <div>
          ...
          <div className="bg-[#F7F7F7] mt-4 border-[1.5px] space-y-2 border-[#ECECEC] rounded-[12px] p-6 w-full text-[#0A3E54]">
            <div className="flex items-center gap-4 text-center">
              <p>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ullam
                nisi sed quia veniam vel accusamus voluptas qui aliquam.
                Similique commodi laudantium repellat dignissimos earum possimus
                placeat veniam quam ea incidunt?
              </p>
            </div>
          </div>
        </div>
