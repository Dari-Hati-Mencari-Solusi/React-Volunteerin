      ...
      <section className="mx-auto w-full px-4 sm:px-6 lg:px-8 max-w-screen-xl py-12">
        ...
        <div className="mb-12">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-2">
              <p className="text-[#0A3E54]">
                Belum ada event yang kamu simpan? Belum ada event yang kamu
                ikuti? Jangan sampai ketinggalan! Temukan event menarik dan
                daftarkan dirimu untuk pengalaman seru!
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center gap-6 py-10">
            ...
            <Link
              to="/"
              className="bg-[#0A3E54] text-white px-8 py-3 rounded-full hover:bg-[#0A3E54]transition-colors"
            >
              Cari Volunteer
            </Link>
          </div>
