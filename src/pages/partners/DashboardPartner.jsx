...
const LazyAreaChart = lazy(() =>
  Promise.all([import("recharts")]).then(([rechartsModule]) => ({
    default: memo(({ data, title, gradientId, theme }) => {
      const { Area, AreaChart, ResponsiveContainer, Tooltip, XAxis, YAxis } =
        rechartsModule;
    ...
    <div className="flex flex-col gap-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="card" style={{ minHeight: "140px" }}>
          <div className="card-header">
            <div
              className="rounded-lg bg-blue-500/20 p-2 text-blue-500 transition-colors"
              style={{
                width: "48px",
                height: "48px",
                display: "flex",
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="card-child" style={{ minHeight: "130px" }}>
          <div className="card-header">
            <div
              className="w-fit rounded-lg bg-blue-500/20 p-2 text-blue-500 transition-colors"
              style={{
                width: "40px",
                height: "40px",
                display: "flex",
      ...
      {showFooter ? (
        <Suspense
          fallback={
            <div style={{ height: "100px" }} className="bg-gray-100 rounded" />
          }
        >
          <Footer />
        </Suspense>
