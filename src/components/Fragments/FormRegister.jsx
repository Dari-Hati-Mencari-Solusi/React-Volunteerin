...
import { Mail, Lock, Check, ArrowLeft, User, Phone, UserCheck } from "lucide-react";
  ...
  return (
    <div className="w-full max-w-md mx-auto px-4">
      <div className="flex flex-col gap-6 px-4">
        <div>
          <Link to="/login-landing" className="flex items-center gap-2">
        ...
        <div className="relative">
          ...
          <select
            ...
            className="h-[60px] w-[390px] pl-12 pr-12 rounded-xl border-2 font-normal border-gray-300 text-[#A1A1A1] focus:outline-none"
          >
